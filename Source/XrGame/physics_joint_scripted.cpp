...
void cphysics_joint_scripted::script_register(lua_State* L)
{
    module(L)[class_<cphysics_joint_scripted>("physics_joint")
                  ...
                  .def("get_stcond_element", &cphysics_joint_scripted::PSecond_element) // TODO: fix typo in exported function name
                  ...
                  .def("get_max_force_and_velocity", &cphysics_joint_scripted::GetMaxForceAndVelocity, policy_list<policy::pure_out_value<2>, policy::pure_out_value<3>>())
