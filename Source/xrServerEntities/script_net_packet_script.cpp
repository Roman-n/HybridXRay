    ...
    module(L)
        [def("script_server_object_version", &script_server_object_version),
            ...
            class_<NET_Packet>("net_packet")
                ...
                .def("w_chunk_open8", &NET_Packet::w_chunk_open8, policy::pure_out_value<2>())
                .def("w_chunk_close8", &NET_Packet::w_chunk_close8)
                .def("w_chunk_open16", &NET_Packet::w_chunk_open16, policy::pure_out_value<2>())
                .def("w_chunk_close16", &NET_Packet::w_chunk_close16)

                .def("r_begin", &NET_Packet::r_begin, policy::pure_out_value<2>())
                //			.def("r",				&NET_Packet::r				)
                .def("r_seek", &NET_Packet::r_seek)
                .def("r_tell", &NET_Packet::r_tell)
                .def("r_vec3", (void(NET_Packet::*)(Fvector&))(&NET_Packet::r_vec3), policy::pure_out_value<2>())
                .def("r_float", (void(NET_Packet::*)(float&))(&NET_Packet::r_float), policy::pure_out_value<2>())
                .def("r_u64", (void(NET_Packet::*)(u64&))(&NET_Packet::r_u64), policy::pure_out_value<2>())
                .def("r_s64", (void(NET_Packet::*)(s64&))(&NET_Packet::r_s64), policy::pure_out_value<2>())
                .def("r_u32", (void(NET_Packet::*)(u32&))(&NET_Packet::r_u32), policy::pure_out_value<2>())
                .def("r_s32", (void(NET_Packet::*)(s32&))(&NET_Packet::r_s32), policy::pure_out_value<2>())
                .def("r_u16", (void(NET_Packet::*)(u16&))(&NET_Packet::r_u16), policy::pure_out_value<2>())
                .def("r_s16", (void(NET_Packet::*)(s16&))(&NET_Packet::r_s16), policy::pure_out_value<2>())
                .def("r_u8", (void(NET_Packet::*)(u8&))(&NET_Packet::r_u8), policy::pure_out_value<2>())
                .def("r_s8", (void(NET_Packet::*)(s8&))(&NET_Packet::r_s8), policy::pure_out_value<2>())
                .def("r_bool", &r_bool)
                ...
                .def("r_float_q16", (void(NET_Packet::*)(float&, float, float))(&NET_Packet::r_float_q16), policy::pure_out_value<2>())
                .def("r_float_q8", (void(NET_Packet::*)(float&, float, float))(&NET_Packet::r_float_q8), policy::pure_out_value<2>())
