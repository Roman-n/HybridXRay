...
void CScriptReader::script_register(lua_State* L)
{
    module(L)[class_<IReader>("reader")
                  ...
                  .def("r_float", (void(IReader::*)(float&))(&IReader::r_float), policy::pure_out_value<2>())
                  .def("r_u64", (void(IReader::*)(u64&))(&IReader::r_u64), policy::pure_out_value<2>())
                  .def("r_s64", (void(IReader::*)(s64&))(&IReader::r_s64), policy::pure_out_value<2>())
                  .def("r_u32", (void(IReader::*)(u32&))(&IReader::r_u32), policy::pure_out_value<2>())
                  .def("r_s32", (void(IReader::*)(s32&))(&IReader::r_s32), policy::pure_out_value<2>())
                  .def("r_u16", (void(IReader::*)(u16&))(&IReader::r_u16), policy::pure_out_value<2>())
                  .def("r_s16", (void(IReader::*)(s16&))(&IReader::r_s16), policy::pure_out_value<2>())
                  .def("r_u8", (void(IReader::*)(u8&))(&IReader::r_u8), policy::pure_out_value<2>())
                  .def("r_s8", (void(IReader::*)(s8&))(&IReader::r_s8), policy::pure_out_value<2>())
                  .def("r_bool", &::r_bool)
